...
class ONNXInfer:
    ...
    def __init__(self, onnx_path):
        """
        Initializes the ONNXInfer instance.

        :param onnx_path: The path to the serialized engine to load from disk.
        """
    ...
    def infer(self, arr):
        ...
        memcpy_host_to_device(self.inputs[0]["allocation"], arr)
